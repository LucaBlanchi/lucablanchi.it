...
The preceding results concern complete rank data inside a fixed skeleton. A finite observable is weaker: it queries only finitely many maps
\[
...
Every finite rank-query observable in at least two parameters has fibres containing any moduli problem that embeds into labelled subspace arrangements. In particular, finite rank windows can be made blind to matroid realization spaces, quiver representation varieties, and matrix-pair similarity problems.
\end{corollary}
