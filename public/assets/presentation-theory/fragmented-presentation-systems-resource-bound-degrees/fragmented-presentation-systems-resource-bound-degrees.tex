...
\begin{remark}
The statement is stronger than nonexistence of a computable classifier. It rules out any computable coordinate system that solves the declared access task with computable overhead: bounded observer refinement, bounded normal-form search, bounded fibre navigation, bounded proof degree, or bounded obstruction radius.
\end{remark}
